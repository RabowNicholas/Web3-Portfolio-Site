...
import casino_snip from "../assets/casino-snip.png";
    ...
    <section className="projects">
      ...
      <div className="projects__cards">
        <div className="projects__card">
          <h3>Crypto Casino</h3>
          <img src={casino_snip} alt="CryptoCasinoLogo-ani" />

          <p>
            Smart contract driven online casino. Users can stake for rewards and
            risk it all at the roulette wheel.
          </p>
        ...
        <div className="projects__card">
          ...
          <p>
            Application to mint random NFT from art collection. Proceeds go to
        ...
        <div className="projects__card">
          ...
          <p>
            Users can connect wallet and exchange ETH for DAPP tokens and
            vice-versa.
          </p>
          <div className="project__links">
            <a
